...
web       = Flask, SQLite, HTML
tools     = Telegram Bot API, BLE HID

[mission]
- Build automation bots that actually do stuff
- Hack hardware with software (legally)
- Connect the physical world to Telegram
```
